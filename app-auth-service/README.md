...
```
cd existing_repo
git remote add origin https://gitlab.com/fast-food1/app-auth-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fast-food1/app-auth-service/-/settings/integrations)
