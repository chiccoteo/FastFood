...
```
cd existing_repo
git remote add origin https://gitlab.com/fast-food1/app-product-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fast-food1/app-product-service/-/settings/integrations)
